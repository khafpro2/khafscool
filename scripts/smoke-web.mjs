...
const pages = [
  { path: '/auth', label: 'auth', marker: 'Connecte-toi en quelques secondes' },
  { path: '/dashboard', label: 'dashboard', marker: 'Mon apprentissage' },
  { path: '/profile', label: 'profile', marker: 'Chargement du profil' },
  { path: '/courses', label: 'courses', marker: 'Chargement du catalogue' },
  ...
  { path: '/badges', label: 'badges', marker: 'Chargement des badges' },
  { path: '/quests', label: 'quests', marker: 'Chargement des quêtes' },
  { path: '/sprint', label: 'sprint', marker: 'Chargement du sprint' },
  { path: '/pricing', label: 'pricing-redirect', marker: 'Chargement du catalogue' },
  { path: '/diagnostics', label: 'diagnostics', marker: 'Diagnostics MVP' },
