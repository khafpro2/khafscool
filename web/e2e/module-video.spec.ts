...
test.describe('Module — section vidéo pilote', () => {
  ...
  test('affiche placeholder FR sur le module 4 Apple (apps VPP)', async ({ page }) => {
  ...
  test('affiche placeholder FR sur le module 4 Jamf (API)', async ({ page }) => {
  ...
  test('affiche placeholder FR sur le module 4 Intune (VPP ABM)', async ({ page }) => {
